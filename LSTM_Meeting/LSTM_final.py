...
input_flist = [ './Inputs/meeting2.csv', './Inputs/meeting5.csv', './Inputs/meeting10.csv', './Inputs/meeting20.csv', './Inputs/meeting50.csv']
output_flist = [ './Outputs/res_meeting2.npy', './Outputs/res_meeting5.npy', './Outputs/res_meeting10.npy', './Outputs/res_meeting20.npy', './Outputs/res_meeting50.npy']
preds_flist = [ './Preds/pred_meeting2.npy', './Preds/pred_meeting5.npy', './Preds/pred_meeting10.npy', './Preds/pred_meeting20.npy', './Preds/pred_meeting50.npy']
...
for index_ in xrange(5):
	...
	with open(preds_fname,'wb') as pr: 
		np.save(pr,predictions)

	with open(output_fname,'wb') as res: 
	...
	with open("model_meeting10.json", "w") as json_file:
