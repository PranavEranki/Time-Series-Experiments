...
meeting2 = np.load('./Outputs/res_meeting2.npy', mmap_mode=None, allow_pickle=True, fix_imports=True, encoding='ASCII').reshape(300,99)[0:100,:]
meeting5 = np.load('./Outputs/res_meeting5.npy', mmap_mode=None, allow_pickle=True, fix_imports=True, encoding='ASCII').reshape(300,99)[0:100,:]
meeting10 = np.load('./Outputs/res_meeting10.npy', mmap_mode=None, allow_pickle=True, fix_imports=True, encoding='ASCII').reshape(300,99)[0:100,:]
meeting20 = np.load('./Outputs/res_meeting20.npy', mmap_mode=None, allow_pickle=True, fix_imports=True, encoding='ASCII').reshape(300,99)[0:100,:]
meeting50 = np.load('./Outputs/res_meeting50.npy', mmap_mode=None, allow_pickle=True, fix_imports=True, encoding='ASCII').reshape(300,99)[0:100,:]
...
np.savetxt("./Class_Output_Probs/res_meeting2.csv", prob_list_meeting2, delimiter=",")
np.savetxt("./Class_Output_Probs/res_meeting5.csv", prob_list_meeting5, delimiter=",")
np.savetxt("./Class_Output_Probs/res_meeting10.csv", prob_list_meeting10, delimiter=",")
np.savetxt("./Class_Output_Probs/res_meeting20.csv", prob_list_meeting20, delimiter=",")
np.savetxt("./Class_Output_Probs/res_meeting50.csv", prob_list_meeting50, delimiter=",")